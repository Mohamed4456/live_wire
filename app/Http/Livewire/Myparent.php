...
public function submitForm(){
    ...
    try {
        ...
        $this->successMessage = " Success Addd  ";
        $this->clearForm();
        $this->currentStep = 1;
    }
    ...
    $this->successMessage = " Success deleted  ";
    ...
    public function submitForm_edit(){
        ...
        $this->successMessage = " Success Edit ";
        return redirect()->to('/parents');
    ...
    public function firstStepSubmit_show()
    {
        $this->showMode = true;
        $this->currentStep = 2;
    ...
    public function secondStepSubmit_show()
    {
        $this->showMode = true;
        $this->currentStep = 3;
